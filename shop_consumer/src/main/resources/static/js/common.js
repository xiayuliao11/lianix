...
function get_province(){
    var url = base_Url+"Home/Api/getRegion/level/1/parent_id/0";
    $.ajax({
        type : "GET",
        url  : url,
...
function get_city(t){
   ...
   // $('#town_id').empty().css('display','none');
    var url = "/index.php/Home/Api/getRegion/level/2/parent_id/"+parent_id;
...
function get_area(t){
    ...
    var url = "/index.php/Home/Api/getRegion/level/3/parent_id/"+parent_id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
...
function get_twon(obj){
    ...
    var url = "/index.php/Home/Api/getTwon/parent_id/"+parent_id;
    $.ajax({
        type : "GET",
        url  : url,
...
function get_category(id,next,select_id){
    ...
    var url=base_Url+"Home/Api/get_category/parent_id/"+id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
